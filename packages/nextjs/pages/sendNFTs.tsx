...
function sendNFTs() {
  ...
  async function mintNft() {
    ...
    const txn = await contract.mint(
      "5790810961207155433",
      "0xfeECc3fEea9bD8A418AA90F99C058a9704eBc72B",
      0,
      correctAddress,
      ipfs,
    );
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            {correctAddress && (
              <>
                {" "}
                <h6>User's Preferred Address is {correctAddress}</h6>
                <div className="flex">
                  <img className="inline-flex h-12 w-12 rounded-full ring-2 ring-white" src={enssAvatar.data} alt="" />
                  <p className="text-sm font-semibold leading-6 text-gray-900 ml-3"> {enss.data}</p>
                </div>{" "}
              </>
            )}
            ...
            <div className="card-actions justify-end">
              <button onClick={getENS} className="btn btn-secondary">
                Get corresponding ens
              </button>
